...
export default function ServGuest() {
  ...
  // Apply filters
  useEffect(() => {
    console.log("ServGuest - Applying filters:", { filterLocation, filterGuests, listingsCount: listings.length });
    let filtered = [...listings];

    // Filter by location (skip if "All Areas" or empty)
    if (filterLocation && filterLocation !== "All Areas") {
      console.log("ServGuest - Filtering by location:", filterLocation);
    ...
    if (filterGuests && filterGuests !== "") {
      console.log("ServGuest - Filtering by guests:", filterGuests);

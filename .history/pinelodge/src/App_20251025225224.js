  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/guestPage/GuestPage' element= {<GuestPage/>}/>
       
        <Route
          path="/hostPage/HomeHost"
          element={
            <ProtectedRoute>
              <HostHome />
            </ProtectedRoute>

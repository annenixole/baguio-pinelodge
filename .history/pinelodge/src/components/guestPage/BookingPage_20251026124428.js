import { Box, Typography, Button, Card, CardContent, CardMedia, Divider, Avatar, Grid, Stack } from "@mui/material";
...
export default function BookingPage() {
    ...
    useEffect(() => {
        const fetchHostName = async () => {
            try {
                if (listing?.hostEmail) { // use email as the user doc id
                    ...
                    <Card sx={{ borderRadius: 4, boxShadow: 4, p: 3 }}>
                        <CardContent>
                            ...
                            <Typography
                                ...
                                sx={{ mb: 0.5 }}
                            >
                                Please take a moment to carefully read and understand our Cancellation Policy prior to making a booking.
                                This ensures transparency and mutual understanding of the terms regarding cancellations, and refunds
                            </Typography>
                            <Button
                                variant="text"
                                sx={{

                                    ...
                                    {photos.map((_, i) => (
                                        <Box
                                            ...
                                            sx={{
                                                ...
                                                height: 8,
                                                borderRadius: "50%",
                                                bgcolor: i === currentImage ? "#fff" : "rgba(255,255,255,0.4)",
                                                cursor: "pointer",
                                                transition: "0.3s",
                                            }}
                    ...
                    <Card sx={{ borderRadius: 4, boxShadow: 4, p: 3 }}>
                        <CardContent>
                            ...
                            <Typography
                                ...
                                color="text.secondary"
                                sx={{ mb: 0.5 }}>
                                Please read and understand our Cancellation Policy before booking to ensure clarity on cancellations, and refunds.
                            </Typography>
                            <Button
                                variant="text"
                                sx={{

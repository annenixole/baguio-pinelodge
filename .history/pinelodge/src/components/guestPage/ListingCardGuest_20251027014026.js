...
export default function ListingCardGuest({ listing, onView }) {
    ...
    const getListingUrl = () => {
        // Encode listing data to pass to BookingPage
        ...
        const url = `${window.location.origin}/BookingPage?listing=${listingData}`;
            ...
            <Box sx={{ position: "relative" }}>
                ...
                >
                    ...
                    <MenuItem onClick={handleShareInstagram}>
                        <InstagramIcon fontSize="small" sx={{ mr: 1.5, color: "#E4405F" }} />
                        Copy for Instagram
                    </MenuItem>
                </Menu>
            </Box>

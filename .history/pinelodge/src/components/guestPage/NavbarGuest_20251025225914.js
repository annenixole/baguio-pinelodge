        ...
        <Toolbar sx={{ justifyContent: "space-between" }}>
          ...
          <Box display="flex" alignItems="center" gap={1}>
            ...
            <Box>
              <Typography
                variant="h6"
                sx={{ fontWeight: "lighter", fontSize: 28, mb: -1, color: "#30410D", fontFamily: "'Kingred Serif', serif" }}
              >
                BAGUIO
              </Typography>
              <Typography
                variant="caption"
                sx={{ letterSpacing: 3, fontSize: 13, color: "#30410D", fontFamily: "'Questrial', sans-serif" }}
              >
                PINELODGE
              </Typography>
            </Box>

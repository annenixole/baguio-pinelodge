import { Box, Typography, Button, Card, CardContent, CardMedia, Divider, Avatar, Grid, Stack, IconButton } from "@mui/material";
...
export default function BookingPage() {
  ...
  // Toggle for booking form on LEFT SIDE
      ...
      >
        ...
        <Box sx={{ flex: 2, maxWidth: 800 }}>
          {!showBookingForm ? (
            ...
            <>
              {/* --- Booking Form Replaces Left Content --- */}
              <Box sx={{ p: 4, borderRadius: 3, boxShadow: 2, backgroundColor: "#fff" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  {["Name", "Email", "Phone number", "No. of Guests"].map((label, i) => (
                    <Box key={i}>

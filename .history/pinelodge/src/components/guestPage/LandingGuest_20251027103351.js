        ...
        <Box sx={{ zIndex: 2, textAlign: "center", width: "100%", px: 2 }}>
          ...
          <Paper
            ...
            sx={{
              ...
              mx: "auto",
              borderRadius: "24px",
              backgroundColor: "rgba(211, 216, 207, 0.8)",
          ...
          >
            ...
            >
              <Typography
                variant="caption"
                sx={{ fontWeight: 600, color: "#30410D", display: "block", mb: 0.5, textAlign: "left" }}
              >
                Type
              </Typography>
            ...
            >
              <Typography
                variant="caption"
                sx={{ fontWeight: 600, color: "#3d3d3d", display: "block", mb: 0.5, textAlign: "left" }}
              >
                Where
              </Typography>
              <FormControl fullWidth variant="standard">
            ...
            >
              ...
              >
                <Typography sx={{ fontWeight: 600, fontSize: "1rem", color: "#3d3d3d" }}>
                  {filterDates || "-"}
                </Typography>
                <KeyboardArrowDownIcon sx={{ color: "#3d3d3d" }} />
              </Box>

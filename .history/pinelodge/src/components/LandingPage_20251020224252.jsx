      ...
      <Box sx={{ py: 8, textAlign: "center", backgroundColor: "#ffffffff", mt: 4}}>
        ...
        <Grid container spacing={3} justifyContent="center">
          {[
            ...
            { icon: <StarIcon sx={{ fontSize: 40, color: "#f9fc69ff;" }} />, title: "Top-Rated Hosts", text: (<>Highly rated hosts <br/> ensuring quality and care</>)},
            { icon: <LocalOfferIcon sx={{ fontSize: 40, color: "#70873F;" }} />, title: "Best Deals", text: (<>Affordable stays <br/> with exclusive seasonal offers</>)},

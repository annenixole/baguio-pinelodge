    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ fontSize: '12px', fontWeight: 300, mt:-1 }}>
            {role === "host"
              ...
              <FormControlLabel
                ...
                label={
                  <Typography variant="body2" sx={{ fontSize: { xs: '12px', sm: '14px' } }}>
                    I agree to the{' '}
                    <Link href="#" style={{ color: '#70873F', textDecoration: 'none', fontWeight: 500 }}>Terms of Service</Link>{' '}and{' '}
                    <Link href="#" style={{ color: '#70873F', textDecoration: 'none', fontWeight: 500 }}>Privacy Policy</Link>
                  </Typography>
                }
              />

  ...
  return (
    <>
      ...
      <Box sx={{ py: 8, textAlign: "center", backgroundColor: "#ffffffff", mt: 4 }}>
        <Typography variant="h4" sx={{ fontWeight: 700, mb: 3, color: "#30410D" }}> Your Ideal Baguio Getaway Awaits </Typography>
        <Grid container spacing={3} justifyContent="center">
          {[
            { icon: <FavoriteIcon sx={{ fontSize: 40, color: "#70873F;" }} />, title: "Comfort & Warmth", text: "Retreat to a cozy escape surrounded by pine-scented air" },

...
export default function ListingGrid({ filter, setFilter, listings, setListings, refreshListings, setSelectedIndex }) {
    ...
    return (
        <Box sx={{ p: 3, backgroundColor: "#f9f9f9ff" }}>
            ...
            <EditListing
                ...
                onUpdated={async () => {
                    await refreshListings(); // refresh listings instantly

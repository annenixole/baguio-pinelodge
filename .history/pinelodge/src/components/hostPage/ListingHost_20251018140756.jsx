  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ backgroundColor: "#f9f9f9ff", borderRadius: 3, p: 3 }}>
        <ListingGrid filter={filter} setFilter={setFilter} listings={listings} setListings={setListings} refreshListings={fetchListings} setSelectedIndex={setSelectedIndex} />
      </Box>

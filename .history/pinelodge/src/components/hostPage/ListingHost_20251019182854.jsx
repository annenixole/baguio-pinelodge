              ...
              <Box component="form" sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <option value="Session Road">Near Session Road</option>
                    <option value="Burnham Park">Near Burnham Park</option>
                    <option value="Camp John Hay">Near Camp John Hay</option>
                    <option value="Mines View">Near Mines View Park</option>
                    <option value="Loakan">Near Loakan</option>
                    <option value="SM Baguio">Near SM City Baguio</option>
                  </select>
                </Box>

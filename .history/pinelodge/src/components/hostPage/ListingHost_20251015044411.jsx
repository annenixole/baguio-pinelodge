...
export default function ListingHost() {
  ...
  const canProceedStep3 =
    listingType === "accommodation" ? listingTitle && description && price && capacity
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ backgroundColor: "#f9fdf9", borderRadius: 3, p: 3 }}>
        <ListingGrid />
      </Box>
            ...
            <Box>
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 4 }}>
                ...
                <Button
                  ...
                  onClick={handleSubmitListing}  // ✅ Replace alert() with Firestore save
                >
                  Finish
                </Button>

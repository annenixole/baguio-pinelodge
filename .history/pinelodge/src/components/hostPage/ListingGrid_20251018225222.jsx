...
export default function ListingGrid({ filter, setFilter, setSelectedIndex,typeFilter, reloadTrigger }) {
        ...
        <Box sx={{ p: 3, backgroundColor: "#f9f9f9ff" }}>
            ...
            >
                <Typography variant="h5" sx={{ fontWeight: 700 }}>
                    {["draft", "published", "all"].includes(filter)
                        ? "All Listings"
                ...
                <ToggleButtonGroup
                    value={filter === "draft" ? "draft" : "published"} // default to published
                    exclusive
                    onChange={(e, newValue) => {

...
import { Card,StarIcon, CardContent, CardMedia, Typography, Box, Chip, Button, IconButton, Tooltip, } from "@mui/material";
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              fontWeight: 600,
              textTransform: "none",
              "&:hover": { textDecoration: "underline", backgroundColor: "#ffff" },
            }}
            onClick={(e) => {

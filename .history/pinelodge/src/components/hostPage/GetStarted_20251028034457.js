      ...
      {step === 1 && (
        ...
        >
          ...
          >
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', mt: -8, zIndex: 3 }}>
              <Grid container spacing={3} justifyContent="center">
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <HomeIcon sx={{ color: '#70873F', fontSize: 28 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{
                ...
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <AttachMoneyIcon sx={{ color: '#70873F', fontSize: 28 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{
                ...
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <PeopleIcon sx={{ color: '#70873F', fontSize: 28 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{

      ...
      {step === 1 && (
        ...
        >
          ...
          >
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', mt: -8, zIndex: 3, pb: 8 }}>
              <Grid container spacing={3}>
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <HomeIcon sx={{ color: '#42A5F5', fontSize: 26 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{
                ...
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <AttachMoneyIcon sx={{ color: '#66BB6A', fontSize: 26 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{
                ...
                <Grid item xs={12} md={4}>
                  ...
                  >
                    ...
                    >
                      <PeopleIcon sx={{ color: '#42A5F5', fontSize: 26 }} />
                    </Box>
                    <Typography
                      variant="h6"
                      sx={{

                ...
                <Box sx={{ p: 3 }}>
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", mt: 0.5 }}>
                                ...
                                {listing.mapUrl && (
                                    <Typography variant="body2" sx={{ mt: 1 }}>
                                        📍 <a href={listing.mapUrl} target="_blank" rel="noopener noreferrer" style={{ color: "#5ca166" }}>
                                            View on Google Maps
                                        </a>
                                    </Typography>
                                )}
                    ...
                    <Box>
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 3, mb: 1.5, color: "text.secondary" }}>
                            {listing.capacity && (
                                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                    ...
                                    <Typography variant="body2">{listing.capacity} Guests</Typography>
                                </Box>
                            )}
                            <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                <HotelIcon fontSize="small" />
                                <Typography variant="body2">
                                    {listing.bedrooms ? `${listing.bedrooms} Bedrooms` : "No bedrooms specified"}
                                </Typography>
                            </Box>
                        </Box>
                        ...
                        <Typography
                            ...
                            sx={{
                                color: "text.secondary",
                                whiteSpace: "pre-wrap",     // wraps lines and keeps spacing
                                wordWrap: "break-word",     // breaks long words
                                overflowWrap: "break-word", // breaks continuous text
                            }}
                        > {listing.description}
                        </Typography>
                    </Box>
                                ...
                                {inclusions.map((item, i) => (
                                    <Grid item xs={6} sm={4} key={i}>
                                        <Stack direction="row" alignItems="center" spacing={1}>
                                            <CheckCircleIcon fontSize="small" sx={{ color: "#5ca166" }} />

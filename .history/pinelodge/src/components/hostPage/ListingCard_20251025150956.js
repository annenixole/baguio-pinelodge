...
export default function ListingCard({ listing, onEdit, onDelete, onView, onPublish, listingAvailability }) {
    ...
    >
      ...
      <Box sx={{ position: "relative" }}>
        ...
        >
          ...
          <ManageOfferModal open={offerModalOpen} onClose={() => setOfferModalOpen(false)}  listingPrice={price} activePromotion={listing.promotion || null}  listingAvailability={listing.availability || null}  />
          {isDraft && (

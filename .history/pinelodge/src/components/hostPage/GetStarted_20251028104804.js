...
export default function GetStarted() {
  ...
  return (
    <Box sx={{ backgroundColor: '#ffffffff', minHeight: '100vh', overflowX: 'hidden' }}>
      <Box
        component="nav"
        sx={{
          display: 'flex',
      ...
      {/* What is hosting section - Full width, outside step 1 */}
      {step === 1 && (
        <Box
          sx={{
            width: '100vw',
        ...
        >
          ...
          >
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', mt: -7, zIndex: 3, pb: 8 }}>
              <Grid
                container
                spacing={3}
                justifyContent="center"
              ...
              >
                ...
                <Grid item xs={12} sm={6} md={3.5}>
                  ...
                  >
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 600, color: '#1C1C1C', mb: 1.5, fontSize: '16px' }}>
                      Welcome Guests
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#757575', fontSize: '13px', lineHeight: 1.6 }}>

        ...
        >
          ...
          <form onSubmit={handleSignup}>
            <Stack spacing={2}>
              ...
              <Box display="flex" alignItems="flex-end" sx={{ mt: 1 }}>
                <Checkbox
                  color="primary"
                  checked={agree}
                ...
                <Typography
                  variant="body2"
                  sx={{ fontSize: { xs: '12px', sm: '14px' }, lineHeight: 1.6 }}>  I agree to the{' '}
                  <span onClick={() => setOpenTOS(true)}
                    style={{ color: "#70873F", cursor: "pointer", fontWeight: 500 }} > Terms of Service </span>{' '} and{' '}
                  <span onClick={() => setOpenPrivacy(true)}
                    style={{ color: "#70873F", cursor: "pointer", fontWeight: 500 }}>  Privacy Policy </span>
                </Typography>
              </Box>
